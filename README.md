...
촬영 화면은 [scripts/start_capture_windows.cmd](scripts/start_capture_windows.cmd)를 더블클릭합니다. [한국어 사용 안내](training/capture_windows/README_KR.md).
이 창은 데이터 수집 도구이며 AI 판정/최종 검사 HMI가 아닙니다.
